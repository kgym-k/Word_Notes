...
import kotlinx.android.synthetic.main.fragment_note_check.*
import kotlinx.android.synthetic.main.fragment_note_check.view.*
...
class NoteCheckFragment() : Fragment() {
    ...
    override fun onCreateView(
        ...
        star_flag = false
        check_flag = true
        val view = inflater.inflate(R.layout.fragment_note_check, container, false)

        mNoteViewModel = ViewModelProvider(this).get(NoteViewModel::class.java)
        recyclerView = view.recyclerview_note_check
        ...
        mNoteViewModel.note.observe(viewLifecycleOwner, Observer { note ->
            ...
            // visibility
            val note_imageView_card: ImageView = view.findViewById(R.id.note_imageView_check)
            val note_text_card: TextView = view.findViewById(R.id.note_textView_check)
        ...
        // fab
        view.fab_note_check.setOnClickListener {
            val action =
                NoteCollectionFragmentDirections.actionNoteCollectionFragmentToNoteEditFragment(currentId)
    ...
    override fun onPrepareOptionsMenu(menu: Menu) {
        ...
        search.setOnActionExpandListener(object: MenuItem.OnActionExpandListener {
            override fun onMenuItemActionExpand(item: MenuItem?): Boolean {
                fab_note_check.visibility = View.GONE
                menu.getItem(1).setVisible(false)
                return true
            }
            override fun onMenuItemActionCollapse(item: MenuItem?): Boolean {
                fab_note_check.visibility = View.VISIBLE
        ...
        searchView.setOnQueryTextListener(object : androidx.appcompat.widget.SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                ...
                mNoteViewModel.rearrangeNote(mNoteViewModel.getIsRecent(), false, true, false, false)
                return false
            }
        })
    ...
    private fun sortBotomm() {
        ...
        bottomSheetSortView.bottom_sort_recent.setOnClickListener {
            bottomSheetDialog.dismiss()
            mNoteViewModel.rearrangeNote(true, false, true, false, false)
        }
        bottomSheetSortView.bottom_sort_front.setOnClickListener {
            bottomSheetDialog.dismiss()
            mNoteViewModel.rearrangeNote(false, false, true, false, false)
        }
